...
if( isset($_POST["submit"])){
    ...
    $query2 = "INSERT INTO user_log VALUES ('$username', '$time', '$aksi')"; 

    $query = "INSERT INTO daftar VALUES ('$username', '$password', '$email', '$phonenum')";
...
<div class="container">
    <section>            
        <form action="" method="post">
            ...
            <a href="signin.php"><button class="btn btn-outline-dark" type="submit" name="submit">Sign Up</button></a>
        </form>
    </section>
</div>
</body>
