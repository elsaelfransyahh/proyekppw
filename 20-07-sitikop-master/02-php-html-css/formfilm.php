...
if( isset($_POST["submit"])){
    ...
    $query1 = "INSERT INTO film VALUES ('$kode_film', '$title', '$jam_tayang', '$harga', '$Gambar')";
...
<body>
    ...
    <div class="movie-section">
        <div class="film">
            <h1>Film</h1> 
            <a href="formnowplaying.php"> add data now playing </a>
            <a href="formcomingsoon.php"> add data coming soon </a>
            <a href="deletefilm.php"> delete data </a>
            <form action="" method="post">
            <h2>
            <ul>
                <li>
                    <label for="kode_film">Kode Film</label>
                    <input type="text" name="kode_film">
                </li>
                <li>
                ...
                <li>
                    ...
                    <input type="text" name="jam_tayang">
                </li>
                <li>
