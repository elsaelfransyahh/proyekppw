...
<body>
    <nav id="navbar-sec" class="navbar navbar-expand-md navbar-black bg-black">
        ...
        <div class="navbar-collapse collapse w-100 order-3 dual-collapse2">
            <ul class="navbar-nav ml-auto">
                ...
                <li class="nav-item">
                    <a href="logout.php"> <button type="button" class="btn btn-dark" style="border-color:silver;"><span class="fa fa-bars"></span></button></a>
                </li>
            </ul>
        </div>
    </nav>
        ...
        <div class="after-hero">
            ...
            <div class="signup-wraper"> 
                <div class="buttonsignup">
                    <a href="PageMembership.php"><button id="signup-button" type="button" class="btn btn-outline-dark">Membership</button></a>
                </div>
            </div>
        </div>
    </div>
    ...
    <div class="movie-section">
        ...
        <a href="formfilm.php"><button id="signup-button" type="button" class="btn btn-outline-dark">ubah data</button></a>
        <a href="log-user-perbaikan.php"><button id="signup-button" type="button" class="btn btn-outline-dark">log user</button></a>
            ...
            <div class="nowplaying-img">
                <?php while 
                    ($row = mysqli_fetch_assoc($result)) : ?>
                        <a href="moviedetails.php?nama=<?= $row['title']; ?>&gambar=<?= $row['Gambar']; ?>"> <img width=200px height=290px display=flex src="<?php echo $row['Gambar'];?>" alt=""> </a>
                <?php endwhile;?>
            </div>
        </div>
