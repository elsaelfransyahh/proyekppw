...
if( isset($_POST["submit"])){
    ...
    $query2 = "INSERT INTO now_playing VALUES ('$kode_film', '$title', '$Gambar', '$harga')";
...
<body>
    ...
    <div class="movie-section">
        <div class="film">
            <h1>Now Playing</h1> 
            <a href="formfilm.php"> to form film </a>
            <a href="formfilmcomingsoon.php"> add data coming soon </a>
