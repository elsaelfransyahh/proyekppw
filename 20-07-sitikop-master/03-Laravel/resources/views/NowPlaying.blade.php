...
<body>
    <center><h2>Now Playing</h2></center>
...
<div class="modal fade" id="exampleModal" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel" aria-hidden="true">
  <div class="modal-dialog" role="document">
    <div class="modal-content">
      ...
      <form action="nowplaying/tambah" method="POST" enctype="multipart/form-data">
                                {{ csrf_field() }}
...
<script>
    var row = 0;
        $(document).ready(function() {
            ...
            $('#nowplaying thead tr').clone(true).appendTo( '#nowplaying thead' );
    $('#nowplaying thead tr:eq(1) th').each( function (i) {
        if (row < 2) {
            var title = $(this).text();
    ...
    var table =   $('#nowplaying').DataTable({
            "processing": true,
            "serverSide": true,
            "ajax": "{{ route('ajaxdata.nowplaying') }}",
