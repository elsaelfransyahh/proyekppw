...
<body>
    ...
    <div class="movie-section">
        <div class="nowplaying">
            ...
            @foreach( $film as $i)
                    <div class="col-lg-3">
                        <a href="moviedetails.php"> <img width=200px height=290px display=flex src="{{ $i->Gambar }}" alt=""> </a>
                        <p>{{ $i->title }}</p>
                    </div>
            @endforeach
            </div>
        ...
        <div class="comingsoon">
            ...
            @foreach( $film as $i)
                    <div class="col-lg-3">
                        <a href="{{url('/moviedetails')}}"> <img width=200px height=290px display=flex src="{{ $i->Gambar }}" alt=""> </a>
                        <p>{{ $i->title }}</p>
                    </div>
            @endforeach
            </div>
